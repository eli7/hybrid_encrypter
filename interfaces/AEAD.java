...
public interface AEAD {
    ...
    /**
     * Provide a statistically unique initialization vector (IV) for new
     * operation of authenticated encryption with associated data.
     * 
     * @param iv
     *            the IV (must be different at each call)
     * @param ivLength
     *            its length in bytes.
     */
     ...
     *            its length in bytes.
     * @param cData
     *            ciphertext buffer for encrypted chunk.
     * 
     * @return the ciphertext. If cData is null, a new buffer is automatically
     *         allocated, otherwise the provided buffer is returned.
     */
     ...
     * 
     * @param cData
     *            the ciphertext chunk.
     * @param cLength
     *            its length in bytes.
     * @param mData
     *            plaintext buffer for decrypted chunk.
     * 
     * @return the ciphertext. If mData is null, a new buffer is automatically
     *         allocated, otherwise the provided buffer is returned.
     */
     ...
     *         one is allocated automatically, otherwise the input buffer is
     *         returned)
     */
